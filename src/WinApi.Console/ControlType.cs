...
namespace WinApi.Console
{
    ...
    public enum CtrlType
    {
        ...
        /// </summary>
        /// <remarks>
        /// Services also have their own notification mechanism for shutdown events. For more information, see <see cref="HandleRef"/> and <see cref="PInvoke.AdvApi32.RegisterServiceCtrlHandler"/>.
        /// This signal can also be generated by an application using ConsoleExtensions.GenerateConsoleCtrlEvent.
        /// </remarks>
