...
namespace WinApi.Kernel32
{
    public static class Clipboard
    {
        public static bool SetText(string text)
        {
            ...
            result = PInvoke.Kernel32.OpenClipboard(IntPtr.Zero);
            if (!result)
            {
                return result;
            }
            ...
            try
            {
                result &= PInvoke.Kernel32.EmptyClipboard();
                ...
                if (result)
                {
                    ...
                    result &= PInvoke.Kernel32.SetClipboardData(13, ptr).ToInt64() == 0;
                }
            }
            finally
            {
                result &= PInvoke.Kernel32.CloseClipboard();
