...
namespace Sandbox
{
    public enum ShowWindowCommands
    {
        ...
        /// <see cref="ShowWindowCommands.Normal"/>, except the window is not activated.
        /// </summary>
        ShowNoActivate = 4,
        ...
        /// <see cref="ShowWindowCommands.ShowMinimized"/>, except the window is not activated.
        /// </summary>
        ShowMinNoActive = 7,

        /// <summary>
        /// Displays the window in its current size and position. This value is similar to
        /// <see cref="ShowWindowCommands.Show"/>, except the window is not activated.
        /// </summary>
        ShowNA = 8,
