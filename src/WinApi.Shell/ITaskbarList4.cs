...
namespace WinApi.Shell
{
    ...
    internal interface ITaskbarList4: ITaskbarList3, ITaskbarList2, ITaskbarList
    {
        ...
        /// <remarks>From ITaskbarList3</remarks>
        [PreserveSig]
        ...
        /// <remarks>From ITaskbarList3</remarks>
        [PreserveSig]
        new HResult SetTabActive(IntPtr hWndTab, IntPtr hWndMDI, uint tbatFlags);
        ...
        /// <remarks>From ITaskbarList3</remarks>
        [PreserveSig]
        new HResult ThumbBarAddButtons(
            IntPtr hWnd,
            uint cButtons,
        ...
        /// <remarks>From ITaskbarList3</remarks>
        [PreserveSig]
        new HResult ThumbBarUpdateButtons(
            IntPtr hWnd,
            uint cButtons,
            [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] THUMBBUTTON[] pButton);
        ...
        /// <remarks>From ITaskbarList3</remarks>
        [PreserveSig]
        new HResult ThumbBarSetImageList(
            IntPtr hWnd,
        ...
        /// <remarks>From ITaskbarList3</remarks>
        [PreserveSig]
        new HResult SetThumbnailTooltip(
            IntPtr hWnd,
